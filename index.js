    ...
    if (message.content === '!setup-ticket') {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription(
                ...
                '# **`1`** `اختر التصنيف المناسب لطلبك من القائمة أدناه لتسهيل خدمتك.` **`2`** `بانتظار الإدارة لقبول التكت، لا تمنشن اي اداري البوت يختار وحده.` **`3`** `فتح التذكرة بدواعي المزاح أو الاستهانة يتعرض صاحبه للعقوبة مباشرة.`\n\n' +
                '```ansi\n' +
                '\u001b[1;30m───── ⋆⋅☆⋅⋆ ────────────────────────────────────────────────── ⋆⋅☆⋅⋆ ─────\u001b[0m\n' +
                '```\n' +
